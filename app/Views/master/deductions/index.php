                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9" >						
                                        <input type="text" class="form-control" placeholder="<?= lang('Deductions.filter.search_placeholder') ?>" id="keyword"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <tr>
                                    <th class="text-center">
                                        <div class="checkbox checkbox-custom">
                                            <input name="checkAll" class="checkAll" value="" id="checkAll" type="checkbox" ex-attr-edit="btn_edit_inquiry" ex-attr-delete="btn_delete_inquiry"  ex-attr-checked="deduction" onclick="handleCheckAll(this.id, 'deduction')">
                                    ...
                                    <th><?= lang('Deductions.inquiry.effective_date') ?></th>
                                    <th><?= lang('Deductions.inquiry.deduction_name') ?></th>
                                    <th><?= lang('Deductions.inquiry.default_value') ?></th>
                                    <th><?= lang('Deductions.inquiry.is_active') ?></th>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="deleteModalLabel"><?= lang('Deductions.modal.delete_all.title') ?></h4>
                    </div>
                    <div class="modal-body">
                        <?= lang('Deductions.modal.delete_all.confirm') ?>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">
                            <?= lang('Deductions.modal.delete_all.back') ?>
                        </button>
                        <button type="button" class="btn btn-danger waves-effect waves-light" onclick="handleDeleteAll('master_potongan/removeSelected','deduction','btn_modal_delete')" id="btn_modal_delete">
                            <?= lang('Deductions.modal.delete_all.submit') ?>
                        </button>
                    </div>
                </div>
            </div>
