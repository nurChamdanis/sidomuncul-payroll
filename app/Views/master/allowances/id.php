            ...
            <form id="formMasterTunjangan" class="form-horizontal" role="form" method="post" action="">
                ...
                <div class="panel panel-default">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" value="<?= isset($allowance) ? $allowance->allowance_code : null ?>" name="allowance_code" required disabled />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label"><?= lang('Allowances.form.allowance_name') ?> <span class="text-danger">*</span></label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" value="<?= isset($allowance) ? $allowance->allowance_name : null ?>" name="allowance_name" required disabled />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label"><?= lang('Allowances.form.default_value') ?> <span class="text-danger">*</span></label>
                                    <div class="col-md-8 mt-10">
                                        <input type="text" id="default_value" class="form-control nominal text-right" value="<?= isset($allowance) ? $allowance->default_value : null ?>" name="default_value" required disabled />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label"><?= lang('Allowances.form.effective_date') ?> <span class="text-danger">*</span></label>
                                    <div class="col-md-8 mt-10">
                                        <input type="text" name="effective_date" id="effective_date" class="text-center form-control dt_picker" value="<?= isset($allowance) ? date('d/m/Y', strtotime($allowance->effective_date)) : date('d/m/Y') ?>" disabled />
                                    </div>
                                </div>
                                <div class="form-group" style="margin-bottom: 20px;">
                                    ...
                                    <div class="col-md-8">
                                        <div class="checkbox checkbox-primary">
                                            <input id="is_active" type="checkbox" name="is_active" disabled <?= ($allowance->is_active == '1') ? 'checked' : '' ?>>
                                            <label for="is_active">
                                                Is Active
                                            </label>
                                        </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3 mt-10" style="display: flex; justify-content:center; align-items:center; gap: 10px;">
                                        <input type="text" class="form-control numericOnly text-center" maxlength="3" value="<?= isset($allowance) ? $allowance->minimum_working_period : null ?>" name="minimum_working_period" required disabled />
                                        <span>Tahun</span>
                                    </div>
                                </div>
                                <div class="form-group">
                                        ...
                                        <?php if (!empty($calculationMode)) : ?>
                                            <?php foreach ($calculationMode as $calculation) : ?>
                                                <div class="radio radio-default">
                                                    <input type="radio" name="calculation_mode" id="calculation_mode_<?= $calculation->system_code ?>" value="<?= $calculation->system_code ?>" required <?= ($allowance->calculation_mode == $calculation->system_code) ? 'checked' : '' ?> disabled>
                                    ...
                                    <div class="col-md-8 mt-10">
                                        <?php if (!empty($calculationType)) : ?>
                                            <?php foreach ($calculationType as $calculation) : ?>
                                                <div class="radio radio-default">
                                                    <input type="radio" name="calculation_type" id="calculation_type_<?= $calculation->system_code ?>" value="<?= $calculation->system_code ?>" required <?= ($allowance->calculation_type == $calculation->system_code) ? 'checked' : '' ?> disabled>
                            ...
                            <ul class="nav nav-tabs tabs-bordered">
                                <li class="active">
                                    <a href="#areagroup" data-toggle="tab" aria-expanded="false">
                                        <span><?= lang('Allowances.form.area_and_group') ?></span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#rules" data-toggle="tab" aria-expanded="true">
                                        <span><?= lang('Allowances.form.rules') ?></span>
                                    </a>
                                </li>
                            </ul>
                                                                ...
                                                                <?php foreach ($areaGrup as $key => $value) : ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <?php
                                                                            $checked = '';
                                                                            if (in_array($value->system_code, $allowance_area_group)) {
                                                                                $checked = 'checked';
                                                                            }
                                                                            ?>
                                                                            <div class="checkbox checkbox-custom">
                    ...
                    <div class="panel-footer">
                        <?php echo create_button($button, "btn_edit", null, "{$allowance->allowance_id}"); ?>
