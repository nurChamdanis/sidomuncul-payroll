                        ...
                        <table id="tableImportExcel" class="table table-striped">
                            <thead>
                                <tr>
                                    <th>Valid</th>
                                    <th>Update</th>
                                    <th class="text-center"><?= lang('Shared.label.company') ?></th>
                                    <th class="text-center"><?= lang('Loan.inquiry.employee_id') ?></th>
                                    <th class="text-center"><?= lang('Loan.inquiry.employee_name') ?></th>
                                    <th class="text-center"><?= lang('Loan.inquiry.loan_type') ?></th>
                                    <th class="text-center"><?= lang('Loan.inquiry.loan_term') ?></th>
                                    <th class="text-center"><?= lang('Loan.inquiry.start_period') ?></th>
                                    <th class="text-center"><?= lang('Loan.inquiry.loan_amount') ?></th>
                                    <th class="text-center"><?= lang('Loan.inquiry.remark') ?></th>
                                    <th class="text-center"><?= lang('Shared.label.created_by') ?></th>
                                    <th class="text-center"><?= lang('Shared.label.changed_by') ?></th>
                                    <th class="text-center"><?= lang('Shared.label.created_at') ?></th>
                                    <th class="text-center"><?= lang('Shared.label.changed_at') ?></th>
                                    <th>Error Message</th>
                                </tr>
