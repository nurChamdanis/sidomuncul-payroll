                ...
                <div class="panel panel-default">
                    ...
                    <form id="form_official_travel" class="form-horizontal" role="form" method="post" action="">
                        <div class="row">
                            ...
                            <div class="col-md-4 m-t-10">
                                <div class="form-group row">
                                    <label class="col-md-3 control-label"><?= lang('Loan.filter.cost_center') ?></label>
                                    <div class="col-md-9">
                                        <select class="form-control select2" name="filterCostCenter" id="filterCostCenter" placeholder="<?= lang('Loan.all.cost_center') ?>">
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <tr>
                                    <th class="text-center">
                                        <div class="checkbox checkbox-custom">
                                            <input name="checkAll" class="checkAll" value="" id="checkAll" type="checkbox" ex-attr-edit="btn_edit_inquiry" ex-attr-delete="btn_delete_inquiry"  ex-attr-checked="loan" onclick="handleCheckAll(this.id, 'loan')">
                                    ...
                                    <th><?= lang('Loan.filter.cost_center') ?></th>
                                    <th><?= lang('Loan.inquiry.employee_id') ?></th>
                                    <th><?= lang('Loan.inquiry.employee_name') ?></th>
                                    <th><?= lang('Loan.inquiry.loan_type') ?></th>
                                    <th><?= lang('Loan.inquiry.loan_term') ?></th>
                                    <th><?= lang('Loan.inquiry.loan_amount') ?></th>
                                    <th><?= lang('Loan.inquiry.start_period') ?></th>
                                    <th><?= lang('Loan.inquiry.end_period') ?></th>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger waves-effect waves-light" onclick="handleDeleteAll('master_loan/removeSelected','loan')" id="btn_modal_delete">
