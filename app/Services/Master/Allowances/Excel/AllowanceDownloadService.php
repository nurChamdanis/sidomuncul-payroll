...
class AllowanceDownloadService extends DownloadExcelService
{
    /** Default Location */
    protected $fileLocation = WRITEPATH  . '/uploads/allowances/template/';

    /** Properties */
    protected $title = 'Template Upload Master Allowance';
    protected $creator = 'Industri Jamu Dan Farmasi Sido Muncul Tbk';
    protected $subject = 'Upload Data Master';
    protected $description = 'Template download for upload data Master Allowance';
    ...
    public function setHeaderUpload($sheet){
        ...
        $sheet->setCellValue('A1', 'Template Master Allowances');
        ...
        $sheet->setCellValue('C2', 'Allowances');
        ...
        $sheet->setCellValue('F3', 'Min. Working Period');
        $sheet->setCellValue('G3', 'Calculation Type');
        $sheet->setCellValue('H3', 'Calculation Mode');
        $sheet->setCellValue('I3', 'GL Account');

        $sheet->mergeCells('J2:J3');
        $sheet->setCellValue('J2', 'Effective Date');
        
        $sheet->mergeCells('K2:L2');
        $sheet->setCellValue('K2', 'Access');
        $sheet->setCellValue('K3', 'Area');
        $sheet->setCellValue('L3', 'Grup');

        $sheet->mergeCells('M2:M3');
        $sheet->setCellValue('M2', 'Rules');
        
        $this->setAlignment($sheet, 'A2:M3', 'horizontal', 'center');
        $this->setAlignment($sheet, 'A2:M3', 'vertical', 'center');
        $this->setBold($sheet, 'A2:M3', true);
        $this->setBorder($sheet, 'A2:M3');
        $this->setBackground($sheet, 'A2:M3', 'FFD966');
