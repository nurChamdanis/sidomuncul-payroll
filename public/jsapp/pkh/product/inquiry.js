...
$(function () {
    /** Company Options */
    OptionsSelect({ id: 'filterCompany', url: 'pkh_product/options/company', payload: payloadCompanyOptions });
    payloadCompanyOptions.company_id = $(this).val();
    ...
    /** Area Options */
    OptionsSelect({ id: 'filterArea', url: 'pkh_product/options/area', payload: payloadAreaOptions });

    /** Area Group Options */
    OptionsSelect({ id: 'filterGrup', url: 'pkh_product/options/role', payload: payloadAreaGroupOptions });
    ...
    /** Datatable Load */
    dataTableLoader = new DataTableLoader('table', 'master_tunjangan/datatable', { ...tableFilters() }, additionalOptions);
    dataTableLoader.setColumnDefs([
        { targets: 0, className: 'text-center', orderable: false },
        {
            ...
            render: (data, type, row) => {
                console.log(row[12]);
                return `<a style="display:block; width: 100%; text-align:left;" href="${SITE_URL}master_tunjangan/id/${row[12]}" class="author">
                            ${data}
                        </a>`;
            },
            name: 'company_id'
        ...
        { targets: 5, className: 'text-left', name: 'allowance_name' },
