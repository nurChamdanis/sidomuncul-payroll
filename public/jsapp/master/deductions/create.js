...
$(function(){
    ...
    OptionsSelect({id: 'gl_id', url: 'master_potongan/options/glaccount', payload: payloadGlAccountOptions});
    formInitialize(form);
});
...
function handleSubmit()
{
    ...
    const submitter = new FormSubmitter('master_potongan/store', serializeArray(form));
