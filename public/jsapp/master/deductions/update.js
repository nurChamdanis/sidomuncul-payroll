...
$(function(){
    OptionsSelect({id: '_company_id', url: 'master_potongan/options/company', payload: payloadCompanyOptions});
...
function handleSubmit()
{
    ...
    const submitter = new FormSubmitter('master_potongan/update', serializeArray(form));
