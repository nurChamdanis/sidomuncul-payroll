...
$(function(){
    /** Company Options */
    OptionsSelect({id: 'filterCompany', url: 'master_tunjangan/options/company', payload: payloadCompanyOptions});
    ...
    /** Area Options */
    OptionsSelect({id: 'filterArea', url: 'master_tunjangan/options/area', payload: payloadAreaOptions});
    
    /** Area Group Options */
    OptionsSelect({id: 'filterGrup', url: 'master_tunjangan/options/areagroup', payload: payloadAreaGroupOptions});
