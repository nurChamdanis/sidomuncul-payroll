...
$(function(){
    OptionsSelect({id: '_company_id', url: 'master_tunjangan/options/company', payload: payloadCompanyOptions});
    ...
    formInitialize(form);
    defaultChecked('areaCheckAll','areaCheckbox');
    defaultChecked('areagrupCheckAll','areagrupCheckbox');
    defaultChecked('payrollrulesCheckAll','payrollrulesCheckbox');
});
...
function handleSubmit()
{
    ...
    const submitter = new FormSubmitter('master_tunjangan/update', serializeArray(form));
